		...
		<div class="col-lg-8">
			...
			<div><h5>Action</h5></div>
		      <?php print '<td>';
		        ...
		        print '<a href= "'.base_url().'admin/delete_order/'.$order_detail->orderId.'" title= "Delete" class="btn btn-danger btn-sm delete" data-confirm = "Are you sure to cencel this order?"> <i class= "fas fa-trash"></i> Cancel Order</a>&nbsp';
