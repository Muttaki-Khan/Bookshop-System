...
CREATE TABLE `books` (
  ...
  `sales_counter` int(11) NOT NULL DEFAULT 0,
  `bookstatus` int(11) DEFAULT 1
...
(3, 'Mechanical engineering', 'All the books from Machanical engineering.', 'ME'),
...
(26, 28, 'Shahan Ali Pranto', 'shahan@gmail.com', '+601121721029', 'Bangsar south,49/b', 'Dhaka', '31415', '262', 1, '2021-01-25 20:23:17', '47', '1', '1', '1'),
(27, 28, 'Shahan Ali Pranto', 'shahan@gmail.com', '+601121721029', 'Bangsar south,49/b', 'Dhaka', '31415', '820', 1, '2021-01-26 11:08:01', '29', '3', '0', '0'),
(28, 28, 'Shahan Ali Pranto', 'shahan@gmail.com', '+601121721029', 'Bangsar south,49/b', 'Dhaka', '31415', '640', 1, '2021-01-26 11:09:28', '46', '3', '0', '0'),
(29, 29, 'Muttaki Khan', 'mkhan@gmail.com', '4646666633', '23/c road-6, block-5', 'Dhaka', '562362462', '680', 1, '2021-01-26 11:24:40', '26', '2', '0', '0'),
(30, 29, 'Muttaki Khan', 'mkhan@gmail.com', '4646666633', '23/c road-6, block-5', 'Dhaka', '562362462', '110', 1, '2021-01-26 18:33:07', '53', '1', '0', '0');
...
CREATE TABLE `tborders` (
  `tborderId` int(11) NOT NULL,
  `userIdfirst` int(11) NOT NULL,
  `namefirst` varchar(200) NOT NULL,
  `contactfirst` varchar(200) NOT NULL,
  `addressfirst` varchar(200) NOT NULL,
  `userIdsecond` int(11) NOT NULL,
  `namesecond` varchar(200) NOT NULL,
  `contactsecond` varchar(200) NOT NULL,
  `addresssecond` varchar(200) NOT NULL,
  `userIdthird` int(11) NOT NULL,
  `namethird` varchar(200) NOT NULL,
  `contactthird` varchar(200) NOT NULL,
  `addressthird` varchar(200) NOT NULL,
  `city` varchar(200) NOT NULL,
  `tbpricewithshp` varchar(200) NOT NULL,
...
INSERT INTO `tborders` (`tborderId`, `userIdfirst`, `namefirst`, `contactfirst`, `addressfirst`, `userIdsecond`, `namesecond`, `contactsecond`, `addresssecond`, `userIdthird`, `namethird`, `contactthird`, `addressthird`, `city`, `tbpricewithshp`, `usercount`, `dateTime`, `bookId`, `del_status`) VALUES
(41, 29, 'Muttaki Khan', '4646666633', '23/c road-6, block-5', 28, 'Shahan Ali Pranto', '+601121721029', 'Bangsar south,49/b', 32, 'Omar been Hasib', '4646666633', '87/c road-6, block 2', 'Dhaka', '89', 3, '2021-01-25 16:56:31', '47', 1),
(43, 29, 'Muttaki Khan', '4646666633', '23/c road-6, block-5', 0, '', '', '', 0, '', '', '', 'Dhaka', '101.67', 1, '2021-01-26 11:36:20', '29', 0),
(44, 28, 'Shahan Ali Pranto', '+601121721029', 'teherheh', 0, '', '', '', 0, '', '', '', 'Dhaka', '81', 1, '2021-01-26 13:14:33', '22', 0),
(45, 29, 'Muttaki Khan', '4646666633', '23/c road-6, block-5', 0, '', '', '', 0, '', '', '', 'Dhaka', '105', 1, '2021-01-26 14:12:05', '19', 0),
(46, 32, 'Omar been Hasib', '4646666633', '87/c road-6, block 2', 0, '', '', '', 0, '', '', '', 'Dhaka', '55', 1, '2021-01-26 14:16:57', '43', 0),
(47, 28, 'Shahan Ali Pranto', '+601121721029', 'Bangsar south,49/b', 0, '', '', '', 0, '', '', '', 'Dhaka', '38.33', 1, '2021-01-26 18:36:01', '53', 0);
...
(25, 'Faiyaz Khan', '93861937419', 'faiyazadmin@gmail.com', '$2y$12$hycskVnc7cprtZBhQHy65.tf/aiqaB5cWvXA7BiePxc/.bWjy5I.O', 'Jalan pantai murni 1, Pantai Hillpark Phase 2, Pantai Hillpark', 'Kuala Lumpur', 'A', '2021-01-14 23:22:00'),
(28, 'Shahan Ali Pranto', '351353522515', 'shahan@gmail.com', '$2y$12$xwhMKZwoTmHv5/1K7p6AZeh3ur.F40LcCQ37YeRae67WukQ2PKbX.', 'wsegsedg eg wgw', 'Dhaka', 'U', '2021-01-23 21:23:41'),
(29, 'Muttaki Khan', '4646666633', 'mkhan@gmail.com', '$2y$12$vXR69D486640O7xkNwL4ZuGh6uq6JyBMOeoRNFzXic6Oco4YEvlW2', '23/c road-6, block-5', 'Dhaka', 'U', '2021-01-25 12:55:25'),
(30, 'Mahin Arafat', '2141241241414', 'mahin@gmail.com', '$2y$12$wIMdwkXrMqiRI6UDoahViefJJ3uvGvmnuf4SaLBc4Qa5Md474PjAC', '12/b road-2, block-9', 'Dhaka', 'U', '2021-01-25 12:56:46'),
(31, 'Faiyaz Khan', '93861937420', 'faiyazuser@gmail.com', '$2y$12$O8RveuGHWDtESDWVYAnIYebgXqKprsPhO2pRM953HHg9G2qWB9Y7.', 'fwfw wa faw faw', 'Tangail', 'U', '2021-01-25 12:57:47'),
(32, 'Omar been Hasib', '32523523551', 'omar@gmail.com', '$2y$12$lF4T8amnxXYJFmUDC0UsweNepNKt.8KraT2dqPVB6gGVW/638Z/pm', '87/c road-6, block 2', 'Dhaka', 'U', '2021-01-25 12:59:14');
...
--
ALTER TABLE `tborders`
  MODIFY `tborderId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
